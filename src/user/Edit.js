                ...
                <div class="mx-auto p-5 border-2 border-slate-50 rounded-md">
                    ...
                    <form onSubmit={updateuser}>
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <input type="text" class="px-2 py-1 text-sm rounded-md border-[1px]" placeholder="Enter Password here..." value={password} onChange={(event)=>{setPassword(event.target.value)}}></input>    
                        </div>
                            <label class="text-sm mb-3">Save</label>
                            <button type="submit" class="md:block px-3 py-2 text-sm bg-green-600  rounded-full text-white hover:bg-white hover:text-green-600 hover:border-2 hover:border-green-600"> <i class="fa fa-add text-xs"></i> Save</button>
                        </div>
                        </div>
                    </form>
                </div>
